...
class TrackList extends React.Component {
	...
	componentWillMount() {
		this.setState({method: 'default'}, () => this.sortTracks(this.props.tracks));
	}
			...
			<div className="album py-5 bg-light">
				...
				<div className='container'>
					<div className="dropdown ">
                        <button className="btn dropdown-toggle" type="button" onClick={() => this.setState({isOpen: !this.state.isOpen})}>
                            Sort
                        </button>
                        <div className={`dropdown-menu ${this.state.isOpen ? 'show' : ''}`}>
                            <a className="dropdown-item" href="#" onClick={() => this.handleSorting('default')}>By default</a>
                            <a className="dropdown-item" href="#" onClick={() => this.handleSorting('title')}>By Title</a>
                            <a className="dropdown-item" href="#" onClick={() => this.handleSorting('author')}>By Author</a>
                        </div>
					</div>
